...
import type { GameModule, Route, RouterOptions, GameState } from '../types/router.js';
...
let routerInstance: PageRouter | null = null;

export function initRouter(options: RouterOptions): PageRouter {
  if (routerInstance) {
...
export function getRouter(): PageRouter | null {
  return routerInstance;
}
