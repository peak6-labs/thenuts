 ...
 */
export function evaluateHandWithSolver(cards) {
 ...
 */
export function compareHandsWithSolver(hand1, hand2) {
 ...
 */
export function getHandDescription(cards) {
 ...
 */
export function findTheNuts(communityCards, availableCards) {
    let bestHand = null;
    let bestHoleCards = ['', ''];
...
//# sourceMappingURL=pokersolver-wrapper.js.map